...
![image](@site/static/img/databases/Relational.png)
...
![image](@site/static/img/databases/Raspberry_Timeseries.png)
...
![image](@site/static/img/databases/Backend_Timeseries.png)
...
![image](@site/static/img/databases/DocumentOriented.png)